...
//     setIsRed(true);
//     setIsVoting(true);
//     setShowSecondArrow(false); // Hide arrow when button is clicked
//     handleAudioPlay("audio3");
//     handleAudioPlay("audio4");
...
//           {showFirstArrow && (
//             <div className="absolute -left-12 top-1/2 transform -translate-y-1/2 blinking-arrow">
//               ➤
//             </div>
//           )}
//           <button
...
//                 <img src="/kamal.png" className="" alt="Symbol" />
//               </td>
//               <td className="border-2 border-black p-4 bg-orange-100 text-center">
//                 <div className="flex flex-row justify-center items-center relative">
//                   {showSecondArrow && (
//                     <div className="absolute -left-8 blinking-arrow">
//                       ➤
//                     </div>
//                   )}
//                   <div
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-base sm:text-lg font-semibold text-blue-800">
          गडचिरोली नगरपरिषद निवडणूक – २०२५
        </h1>
        <h2 className="text-xl sm:text-2xl font-bold text-red-600 mt-2">डमी मतदान यंत्र</h2>
        
        <div className="relative inline-block w-full sm:w-auto px-8 sm:px-0">
          {showFirstArrow && (
            <div className="absolute left-0 sm:-left-12 top-1/2 transform -translate-y-1/2 blinking-arrow">
              ➤
            </div>
          )}
          <button
            className="bg-indigo-800 text-white py-2 px-4 rounded-md text-base sm:text-lg mt-4 shadow-md w-full sm:w-auto"
            onClick={handleButtonClick2}
          >
            डेमो मतदानासाठी कमळ निशाणी समोरील निळे बटन दाबावे
          </button>
        ...
        <p className="text-sm sm:text-md font-medium mt-6 px-2">
          मतदानाच्या दिवशी सुद्धा <span className="font-bold">कमळ</span> या
          चिन्हासमोरील बटन दाबून{" "}
          <span className="font-bold">सौ. ॲड प्रणोती सागर निंबोरकर (भांडेकर)</span> यांना प्रचंड मतांनी
          विजयी करा !
      ...
      <div className="bg-yellow-400 text-center py-4 px-4 sm:px-6">
        <p className="text-black font-bold text-xl sm:text-2xl md:text-3xl">
          "कमळ" या चिन्हासमोरील बटन दाबून प्रचंड मतांनी विजयी करा.
        </p>
        <p className="text-black text-base sm:text-lg md:text-xl mt-2">
          मतदान दिनांक ०२ डिसेंबर २०२५ स. ०७:०० ते सायं. ०६:००
        </p>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full border-2 border-solid border-black">
          ...
          <tbody>
            <tr>
              <td className="border-2 border-black p-2 text-center text-xl font-bold">१.</td>
              <td className="border-2 border-black text-center text-sm sm:text-base font-bold w-65 px-1 sm:px-2">
                सौ. ॲड प्रणोती सागर निंबोरकर (भांडेकर)
              </td>
              <td className="border-2 border-black text-center w-16">
                <img src="/tai.png" className="m-auto" alt="Candidate" />
              ...
              <td className="border-2 border-black p-4 bg-orange-100 text-center">
                <div className="flex flex-row justify-center items-center relative">
                  {showSecondArrow && (
                    <div className="absolute -left-4 sm:-left-8 blinking-arrow">
                      ➤
                    </div>
                  )}
                  <div
                    className={`w-6 h-5 sm:w-8 sm:h-6 rounded-full border-2 border-black inline-block mr-1 sm:mr-2 ${
                      isRed ? "bg-red-500" : ""
                    }`}
                  ></div>
                  <button
                    onClick={handleButtonClick}
                    disabled={isVoting}
                    className="bg-blue-900 text-white rounded-full px-3 sm:px-4 py-1 text-sm sm:text-base shadow-lg disabled:opacity-50"
                  >
                    {isVoting ? "..." : "बटण दाबा"}
                  </button>
                </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center p-4 text-gray-600 text-xs sm:text-sm gap-2">
        <span>2025 © <a href="https://shakktii.in" className="text-blue-500 hover:underline">SHAKKTII.IN</a></span>
